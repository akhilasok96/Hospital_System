	    ...
	    <div class="col-12 col-md-6 col-lg-6 col-xl-5">
	      ...
	      <div class="card-body p-5 text-center">
	        ...
	        <div class="mb-md-5 mt-md-2">
	          ...
	          <h2 class="fw-normal mb-4">User Register</h2>
	          ...
	          <form action="user_register" method="post">
	            <div class="form-outline form-primary mb-3">
	              <input style="border: 1px solid #0275d8;" type="text" name="fullname"
			...
			<div class="form-outline form-primary mb-3">
	            ...
	            <button class="btn btn-outline-primary mt-4 btn-lg px-5" type="submit">Register</button>
	          </form>
	        </div>
	      </div>
	    </div>
